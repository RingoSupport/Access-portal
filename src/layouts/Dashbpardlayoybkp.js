...
const BRAND_COLORS = {
	primary: ACCESS_THEME.primary,         // Orange
	secondary: ACCESS_THEME.primaryLight,  // Light orange
	dark: BRAND.sidebarBg,                 // Sidebar background
	textMuted: ACCESS_THEME.text,          // Text
	showdark: "#636463",
	white: "#fff",
	black: "#000",
};
												...
												{item.children
													...
													.map((subItem, subIdx) => (
														<NavLink
															...
															to={`/${subItem.path}`}
															className={({ isActive }) =>
																`flex items-center gap-3 px-5 py-2.5 text-sm rounded-md mx-2 my-0.5 transition hover:bg-[#898989]
                                                                    border-l-4
                                                                    ${
																		isActive
																		? `bg-red-950 text-[${BRAND_COLORS.white}] border-[${BRAND_COLORS.dark}]`
																		: `hover:bg-[${BRAND_COLORS.primary}] text-white border-transparent`
																	}
                                                                `
															}
															end={false}
